# Historical: AG Grid + Module Federation Vite scanner reproduction

This document describes the original `1.21.2` named-export scanner failure.
It is preserved for history. The active reproduction in this folder now covers
the `eager: false` shared-provider preload behavior; see the root
`README.md` and `mf-issue.md`.
