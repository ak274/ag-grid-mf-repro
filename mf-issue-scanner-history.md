# Historical issue: named-export scanner failure

The issue below is the original `@module-federation/vite@1.21.2` scanner
report. It is preserved for history. The active issue composition is in
`mf-issue.md`.
